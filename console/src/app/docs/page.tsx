  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 space-y-10">
        <div>
          <h1 className="text-3xl font-bold mb-3">Dasturchilar uchun hujjatlar</h1>
          <p className="text-muted">
            OnDexMap API'si Google Maps Platform'ga o'xshab ishlaydi: geokodlash (nom → koordinata), teskari
