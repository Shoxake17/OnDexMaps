...
func setEnv(t *testing.T, kv map[string]string) {
	...
	for _, k := range []string{
		...
		"KEY_PEPPER", "METER_DATABASE_URL", "FIRST_PARTY_ORIGINS", "V1_FIRST_PARTY_ONLY",
		"CONSOLE_DATABASE_URL", "CONSOLE_HTTP_ADDR", "CONSOLE_ORIGIN", "RESEND_API_KEY",
		"MAIL_FROM", "TURNSTILE_SECRET", "BILLING_INSTRUCTIONS",
	} {
		t.Setenv(k, "")
	}
	for k, v := range kv {
